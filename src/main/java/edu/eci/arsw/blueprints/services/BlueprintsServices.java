...
public class BlueprintsServices {
    ...
    public void deleteBlueprint(String author, String bpname) throws BlueprintNotFoundException {
        // Verifica si el blueprint existe antes de intentar eliminarlo
        if (bpp.getBlueprint(author, bpname) != null) {
            bpp.deleteBlueprint(author, bpname);
        } else {
            throw new BlueprintNotFoundException("El blueprint no existe o no se puede eliminar.");
        }
    }
